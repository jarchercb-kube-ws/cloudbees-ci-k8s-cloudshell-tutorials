...
gcloud container clusters create "jarchercb" \
    --region "us-east1" \
...
```bsh
ping jarchercb.workshop.cb-sa.io
```
...
The Operations Center for your CloudBees CI cluster should be running or starting up, and available at: [http://jarchercb.workshop.cb-sa.io]/cjoc](http://jarchercb.workshop.cb-sa.io]/cjoc])
